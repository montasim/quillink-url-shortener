    ...
    return (
        <section className="py-24 px-6 bg-background">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Contact CTA */}
                <div className="mt-24 relative overflow-hidden p-10 md:p-12 rounded-[32px] bg-gradient-to-br from-muted/50 to-muted/30 border border-border group">
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Button
                                size="lg"
                                className="h-14 px-8 rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 shadow-xl shadow-primary/20 font-bold text-base"
                                asChild
                            >
                            ...
                            <Button
                                size="lg"
                                variant="outline"
                                className="h-14 px-8 rounded-xl border-border bg-background hover:bg-muted font-bold text-base"
                                asChild
                            >
