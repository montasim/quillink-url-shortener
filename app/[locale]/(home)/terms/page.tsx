...
const TermsPage = () => {
    ...
    return (
        ...
        >
            ...
            <section>
                ...
                <div className="space-y-4 text-muted-foreground">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                        {['0', '1', '2', '3', '4', '5'].map((i) => (
                            <li key={i}>
                                {t(`sections.responsibilities.infoList.${i}`)}
                            </li>
                        ))}
                    </ul>
                </div>
            ...
            <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">
                    {t('sections.qrCodes.title')}
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                    {t('sections.qrCodes.content')}
                </p>
            </section>

            <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">
                    {t('sections.textSharing.title')}
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                    {t('sections.textSharing.content')}
                </p>
            </section>

            <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">
                    {t('sections.urlShortening.title')}
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                    {t('sections.urlShortening.content')}
                </p>
            </section>
