            ...
            <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                        {[
                            { label: t('activeSessions'), icon: <Activity className="w-5 h-5" />, color: 'bg-emerald-500/10 text-emerald-500' },
                            { label: t('liveClickStream'), icon: <Zap className="w-5 h-5" />, color: 'bg-amber-500/10 text-amber-500' },
                        ].map((item, i) => (
